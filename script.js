...
function trocarImagem() {
    ...
    const pastaCorSelecionada = opcoesCores[corSelecionada].pasta;
    imagemVisualizacao.src = `./imagens/opcoes-cores/${pastaCorSelecionada}/imagem-${imagemSelecionada}.jpeg`;
}
